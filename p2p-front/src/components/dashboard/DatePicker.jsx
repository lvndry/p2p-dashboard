        ...
        <Row>
            <Col>
              <ReactDatePicker
                    ...
                    onChange={(date) => {
                      this.props.onDateChange(date.getTime(), 'start');
                      this.setState((prevState) => {
                        return { values: [date.getTime(), prevState.values[1]] };
                      });
                    }}
                    dropdownMode='select'
              />
            ...
            <Col>
              <ReactDatePicker
                ...
                onChange={(date) => {
                  this.props.onDateChange(date.getTime(), 'end');
                  this.setState((prevState) => {
                    return { values: [prevState.values[0], date.getTime()] };
                  });
                }}
